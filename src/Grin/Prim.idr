...
getConstVal = \case
    ...
    I8 i => primTagUnary "Int8" $ LInteger i
    I16 i => primTagUnary "Int16" $ LInteger i
    I32 i => primTagUnary "Int32" $ LInteger i
    I64 i => primTagUnary "Int64" $ LInteger i
    BI i => primTagUnary "Integer" $ LInteger i
    ...
    WorldVal => primTagNullary "World"
    IntType => primTagNullary "IntType"
    Int8Type => primTagNullary "Bits8Type"
    Int16Type => primTagNullary "Bits16Type"
    Int32Type => primTagNullary "Bits32Type"
    Int64Type => primTagNullary "Bits64Type"
    IntegerType => primTagNullary "IntegerType"
    Bits8Type => primTagNullary "Bits8Type"
    Bits16Type => primTagNullary "Bits16Type"
    Bits32Type => primTagNullary "Bits32Type"
    Bits64Type => primTagNullary "Bits64Type"
    StringType => primTagNullary "StringType"
    CharType => primTagNullary "CharType"
    DoubleType => primTagNullary "DoubleType"
    WorldType => primTagNullary "WorldType"
...
getConstPat = \case
    I i => LitPat $ LInt i
    I8 i => LitPat $ LInteger $ cast i
    I16 i => LitPat $ LInteger $ cast i
    I32 i => LitPat $ LInteger $ cast i
    I64 i => LitPat $ LInteger $ cast i
    ...
    Int8Type => NodePat (primTag "Bits8Type") []
    Int16Type => NodePat (primTag "Bits16Type") []
    Int32Type => NodePat (primTag "Bits32Type") []
    Int64Type => NodePat (primTag "Bits64Type") []
...
unwrapPrim (MkAConstAlt c _) v = case c of
    ...
    I8 _ => VTagNode (primTag "Int8") [SVar v]
    I16 _ => VTagNode (primTag "Int16") [SVar v]
    I32 _ => VTagNode (primTag "Int32") [SVar v]
    I64 _ => VTagNode (primTag "Int64") [SVar v]
